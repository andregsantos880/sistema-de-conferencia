...
const SECTION_COLORS: Record<ChangelogSection, { bg: string; text: string; border: string; badge: string }> = {
  added: {
  ...
  notes: {
    ...
    badge: 'bg-gray-100 dark:bg-gray-900/20 text-gray-700 dark:text-gray-300',
  },
};
    ...
    <div className={`rounded-lg border ${colors.border} ${colors.bg} p-4`}>
      ...
      <ul className="space-y-2">
        {items.map((item, index) => (
          ...
          >
            <span className={`mt-1.5 size-1.5 rounded-full flex-shrink-0 ${colors.badge}`} />
