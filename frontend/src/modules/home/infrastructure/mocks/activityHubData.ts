...
export const mockCommandSuggestions: CommandSuggestion[] = [
  { id: 'cmd-1', label: 'Invite user', description: 'Send an invitation to a new user', icon: 'UserPlus', path: '/management/users?action=invite', category: 'action' },
  { id: 'cmd-2', label: 'Create team', description: 'Create a new team', icon: 'UsersRound', path: '/management/teams?action=create', category: 'action' },
  { id: 'cmd-3', label: 'Open calendar', description: 'View calendar events', icon: 'Calendar', path: '/apps/calendar', category: 'navigation' },
  { id: 'cmd-4', label: 'Send test email', description: 'Send a test notification email', icon: 'Mail', action: 'sendTestEmail', category: 'action' },
  { id: 'cmd-5', label: 'Go to Users', description: 'User management', icon: 'Users', path: '/management/users', shortcut: 'G U', category: 'navigation' },
  { id: 'cmd-6', label: 'Go to Teams', description: 'Team management', icon: 'UsersRound', path: '/management/teams', shortcut: 'G T', category: 'navigation' },
  { id: 'cmd-7', label: 'Go to Settings', description: 'System settings', icon: 'Settings', path: '/settings', shortcut: 'G S', category: 'navigation' },
  { id: 'cmd-8', label: 'Open Kanban', description: 'Kanban boards', icon: 'Kanban', path: '/apps/kanban', category: 'navigation' },
];
...
export const mockFocusItems: FocusItem[] = [
  {
    ...
    priority: 'high',
    actionLabel: 'Review',
    actionPath: '/management/users?status=invited',
  },
  {
    id: 'focus-2',
    type: 'event',
  ...
  },
  {
    ...
    priority: 'low',
    actionLabel: 'Edit',
    actionPath: '/apps/email/templates',
  },
];
...
export const mockRecentModules: RecentModule[] = [
  { id: 'mod-users', name: 'Users', path: '/management/users', icon: 'Users', lastVisitedAt: new Date(Date.now() - 1000 * 60 * 5).toISOString(), visitCount: 24 },
  { id: 'mod-teams', name: 'Teams', path: '/management/teams', icon: 'UsersRound', lastVisitedAt: new Date(Date.now() - 1000 * 60 * 30).toISOString(), visitCount: 12 },
  { id: 'mod-email', name: 'Email', path: '/apps/email', icon: 'Mail', lastVisitedAt: new Date(Date.now() - 1000 * 60 * 60).toISOString(), visitCount: 8 },
  { id: 'mod-calendar', name: 'Calendar', path: '/apps/calendar', icon: 'Calendar', lastVisitedAt: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString(), visitCount: 15 },
  { id: 'mod-kanban', name: 'Kanban', path: '/apps/kanban', icon: 'Kanban', lastVisitedAt: new Date(Date.now() - 1000 * 60 * 60 * 3).toISOString(), visitCount: 6 },
];
