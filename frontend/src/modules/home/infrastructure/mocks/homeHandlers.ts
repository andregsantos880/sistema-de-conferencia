...
export const homeHandlers = [
  ...
  http.get(api('/home/dashboard'), async () => {
    await delay(300);
    return ok(getDashboard());
  }),

  // PATCH /home/checklist/:id - Update checklist item
  http.patch(api('/home/checklist/:id'), async ({ params, request }) => {
    await delay(200);
