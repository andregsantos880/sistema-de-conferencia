    ...
    return (
      <div className="p-6">
        <div className="rounded-lg border border-destructive/50 bg-destructive/10 p-6 text-center">
          <h2 className="text-lg font-semibold text-destructive">{t('errors.loadFailed')}</h2>
          <p className="text-sm text-muted-foreground mt-2">{t('errors.loadFailedDescription')}</p>
        </div>
      </div>
    );
  }
