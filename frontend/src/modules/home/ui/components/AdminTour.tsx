...
export function AdminTour() {
  ...
  const steps: TourStep[] = [
    ...
    },
    {
      ...
      content: t('tour.steps.stats.content', 'View key metrics about your workspace at a glance. Click any card to see more details.'),
      position: 'bottom',
    },
    {
      target: '[data-tour="quick-actions"]',
      title: t('tour.steps.quickActions.title', 'Quick Actions'),
      content: t('tour.steps.quickActions.content', 'Perform common tasks quickly without leaving the dashboard.'),
      position: 'top',
    },
    {
    ...
    },
    {
      ...
      content: t('tour.steps.checklist.content', 'Track your progress setting up the workspace. Complete these tasks to get started.'),
      position: 'top',
    },
  ];
