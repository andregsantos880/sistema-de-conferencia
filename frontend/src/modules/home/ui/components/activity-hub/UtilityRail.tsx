          ...
          {stats.map((stat) => {
            ...
            return (
              <button
                ...
                onClick={() => {
                  if (stat.id === 'stat-users') navigate('/management/users');
                  else if (stat.id === 'stat-teams') navigate('/management/teams');
                  else if (stat.id === 'stat-invites') navigate('/management/users?tab=invites');
                }}
              >
