  ...
  const steps: TourStep[] = [
    {
      ...
      content: t('powerTips.steps.command.content', 'Use the command center to quickly search, navigate, or take actions. Press ⌘K to open from anywhere.'),
      position: 'bottom',
    },
    {
      target: '[data-tour="todays-focus"]',
      title: t('powerTips.steps.focus.title', "Today's Focus"),
      content: t('powerTips.steps.focus.content', 'See your most important tasks and pending items. High priority items appear first.'),
      position: 'right',
    },
    {
      target: '[data-tour="activity-stream"]',
      title: t('powerTips.steps.activity.title', 'Activity Insights'),
      content: t('powerTips.steps.activity.content', 'Track recent actions in your workspace. User actions are highlighted for quick scanning.'),
      position: 'left',
    },
    {
      target: '[data-tour="utility-rail"]',
      title: t('powerTips.steps.utility.title', 'Utility Rail'),
      content: t('powerTips.steps.utility.content', 'Quick access to system stats, recently used modules, and keyboard shortcuts.'),
      position: 'left',
    },
  ];
