...
const checklistConfig: Record<string, { icon: typeof UserPlus; path: string; tourTarget?: string }> = {
  inviteUsers: { icon: UserPlus, path: '/management/users', tourTarget: 'sidebar-users' },
  createTeam: { icon: UsersRound, path: '/management/teams', tourTarget: 'sidebar-teams' },
  configureEmail: { icon: Mail, path: '/apps/email', tourTarget: 'sidebar-email' },
  reviewNotifications: { icon: Bell, path: '/management/notifications', tourTarget: 'sidebar-notifications' },
  exploreApps: { icon: LayoutGrid, path: '/apps', tourTarget: 'sidebar-apps' },
};
